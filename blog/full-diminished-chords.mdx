...
<Sequence speed="arpeggio">
  <Part notes="C Eb Gb A" label="C dim"/>
  <Part notes="Eb Gb A C" label="Eb dim"/>
  <Part notes="Gb A C Eb" label="Eb dim"/>
  <Part notes="A C Eb Gb" label="Eb dim"/>
</Sequence>
...
<Sequence speed="arpeggio">
  ...
  <Part notes="E G Bb C#" label="E dim"/>
  <Part notes="G Bb C# E" label="G dim"/>
  <Part notes="Bb C# E G" label="Bb dim"/>
</Sequence>
