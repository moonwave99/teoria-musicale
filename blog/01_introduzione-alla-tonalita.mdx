...
**Importante**: le tre note di una triade si chiamano **nota di base** (o _root note_ in gergo sassone), **terza** e **quinta**. Perché non prima seconda e terza scusa? Capiremo presto il perché, per adesso tenetelo a mente e guardate un paio di esempi:
...
<Score defaultNoteLength="1" tempo={100} startOctave={1} octaves={5}>
V: V1 clef=treble
V: V2 clef=bass
